...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  , ((modMask, xK_q), kill )
  , ((modMask, xK_o), spawn $ "rofi-theme-selector" )
  , ((modMask, xK_t), spawn $ "st" )
  , ((modMask, xK_x), spawn $ "qdbus org.kde.ksmserver /KSMServer org.kde.KSMServerInterface.logout -1 -1 -1" )
  ...
  , ((modMask .|. shiftMask , xK_Return ), spawn $ "rofi -show file-browser")
  , ((modMask .|. shiftMask , xK_d ), spawn $ "rofi -show drun -fullscreen")
